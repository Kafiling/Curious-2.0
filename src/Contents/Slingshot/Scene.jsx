...
export const App = () => {
  ...
  useEffect(() => {
   ...
   const frictionAir = 0
    ...
    const stack1 = Composites.stack(750, 250, 9, 5, 0, 0, function(x, y) {
    ...
    const pyramid1 = Composites.pyramid(300, 250, 9, 10, 0, 0, function(x, y) {
      return Bodies.rectangle(x, y, 25, 40,
        {
          friction: .5,
        });
  ...
  const pyramid2 = Composites.pyramid(750, 90, 9, 5, 0, 0, function(x, y) {
    ...
    World.add(engine.world, [floor, balls,constraint,stack1,pyramid1,pyramid2]);
